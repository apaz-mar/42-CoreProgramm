...
/*   Updated: 2025/07/05 12:37:10 by apaz-mar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_data	*parse_command(t_token *token, t_data *data);
t_data	*parse_redirection(t_token *token, t_data *cmd_node, t_data *data);
